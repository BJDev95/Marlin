...
#define STRING_CONFIG_H_AUTHOR "(BJ, Mini Kossel)" // Who made the changes.
...
#define DEFAULT_DELTA_RADIUS 98.38
...
#define Z_PROBE_RETRACT_END_LOCATION {0, 0, 5, 0}     // X, Y, Z, E end location for z-probe retract sequence
...
#define MANUAL_Z_HOME_POS 217.33 // 213.67 // For delta: Distance between nozzle and print surface after homing.
